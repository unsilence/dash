...
class RecommendHistory extends Component {
  ...
  deleteHandler = (itm) => {
    this.state.dispatch({
      type: 'recoms/historyrecoms/remove',
      payload: {id:itm._id},
    });
  }
...
function mapStateToProps (state){
  const {list, total, page ,categoryMap} = state["recoms/historyrecoms"];
  return {
    loading: state.loading.models["recoms/historyrecoms"],
...
export default connect(mapStateToProps,mapDispatchToProps)(RecommendHistory);
