...
export var stockOption = function (stock) {
    ...
    stock.effects.fetch = function* ({ payload: { page, searchWords } }, { call, put }) {
        ...
        // 无条件的
        const stocks = yield call(service["StockService"].fetch, { page, filter });
        ...
        const rd = { data: stocks.data.data.list, total: stocks.data.data.count, skusMap, spusMap, countryMap: countryMap, categoryMap: categoryMap, page: parseInt(page), searchWords: searchWords }
